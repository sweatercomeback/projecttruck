class CreateTruckAttributeData < ActiveRecord::Migration
def self.up
    ...
    @condition.name = "emaculate"
    @condition.save
    @condition = Condition.new
    @condition.name = "awesome"
    @condition.save
    @condition = Condition.new
    @condition.name = "pretty good"
    @condition.save
    @condition = Condition.new
    @condition.name = "eh"
    @condition.save
    @condition = Condition.new
    @condition.name = "some rust"
    @condition.save
    @condition = Condition.new
    @condition.name = "looks nice, runs bad"
    @condition.save
    @condition = Condition.new
    @condition.name = "runs nice, looks bad"
    @condition.save
    @condition = Condition.new
    @condition.name = "tow job"
    @condition.save
